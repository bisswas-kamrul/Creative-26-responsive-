  ...
  return (
    ...
    <div className="bg-blue-900">
        <Container>
            ...
            <Flex className={"flex-col gap-y-3 md:flex-row justify-center gap-x-10 mt-5"}>
                 <div className=" w-[360px] sm:w-full bg-white rounded-2xl drop-shadow-sm border-2 border-transparent hover:border-2 hover:border-blue-500 transition-[0.4s]">
                        <div className="text-center">
                            <Images ImgSrc={stander} AltSrc={"stander"} className={" rounded-[10px]  sm:w-full"}/>
                 ...
                 <div className=" w-[360px] sm:w-full bg-white rounded-2xl drop-shadow-sm border-2 border-transparent hover:border-2 hover:border-blue-500 transition-[0.4s]">
                        <div className="text-center">
                            <Images ImgSrc={stander2} AltSrc={"stander2"} className={" rounded-[10px]  sm:w-full"}/>
                                    <p className=" py-3">23/03/2025</p>                           
                            <div className="">
                                <h4 className=" font-inter font-semibold text-xl text-[#181818]">Business Plans That Fit <br></br> Your Best Blog</h4>
                                <p className=" font-inter text-[16px] text-[#5D5D5D]">There are many variations of passages <br></br>  of Lorem Ipsum , but the majority have <br></br>suffered alteration in some form.</p>
                 ...
                 <div className=" w-[360px] sm:w-full bg-white rounded-2xl drop-shadow-sm border-2 border-transparent hover:border-2 hover:border-blue-500 transition-[0.4s]">
                        <div className="text-center">
                            <Images ImgSrc={stander3} AltSrc={"stander3"} className={" rounded-[10px]  sm:w-full "}/>
                                    <p className=" py-3">23/03/2025</p>                           
                            <div className="">
                                <h4 className=" font-inter font-semibold text-xl text-[#181818]">Business Plans That Fit <br></br> Your Best Blog</h4>
                                <p className=" font-inter text-[16px] text-[#5D5D5D]">There are many variations of passages <br></br>  of Lorem Ipsum , but the majority have <br></br>suffered alteration in some form.</p>
